...
bool Foam::setEndPointTwisting::setBC()
{
   ...
   // Pout << regionName_ << ", curRadius: " << curRadius << endl;
    ...
    // else
    {
        ...
        {
            Info << "Updated Lagrangian solver" << endl;
            scalar oldTheta =
        ...
        Info << "new end position befor replace " << newPosition << endl;
        newPosition.replace(0, 5);
        
        Info << "After replace " << tab << newPosition << endl;
        ...
        {
        //	Info << "Inside axialForceFVpatchVector" << endl;
        ...
        // Pout << "curPosition" << tab  << curPosition << "change" << tab << mag(newPosition - curPosition) << endl;

        // Pout << W.boundaryField()[endPatchIndex_] << endl;
    }
