...
bool Foam::setEndPointTwisting::setBC()
{
...

    {
        ...
        // Zero displacement for first two beams
        W.boundaryField()[endPatchIndex_][0] = vector::zero;
        W.boundaryField()[endPatchIndex_][1] = vector::zero;

        W.boundaryField()[endPatchIndex_] ==
            W.boundaryField()[endPatchIndex_] + vector(0.1, 0, 0);
