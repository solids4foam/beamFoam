...
plot \
    energyDataFile using 1:2 with lines dt 1 lc rgb "red"   lw 1 title 'E_{int}', \
    ''            using 1:3 with lines dt 1 lc rgb "blue"  lw 1 title 'E_{kin}', \
    ''            using 1:6 with lines dt 1 lc rgb "black" lw 2 title 'E_{tot}'
