...
template<class Type>
void Foam::BlockParCholeskyPrecon<Type>::calcDecoupledPreconDiag()
{
...
template<class Type>
void Foam::BlockParCholeskyPrecon<Type>::decoupledPrecondition
(
    Field<Type>& x,
    const Field<Type>& b
) const
...
template<class Type>
void Foam::BlockParCholeskyPrecon<Type>::decoupledPreconditionT
(
    Field<Type>& xT,
    const Field<Type>& bT
) const
