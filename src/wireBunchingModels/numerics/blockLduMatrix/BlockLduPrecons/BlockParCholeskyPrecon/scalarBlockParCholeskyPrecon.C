...
#ifndef scalarBlockParCholeskyPrecon_H
#define scalarBlockParCholeskyPrecon_H
...
template<>
void Foam::BlockParCholeskyPrecon<scalar>::calcPreconDiag()
{
...
template<>
void Foam::BlockParCholeskyPrecon<scalar>::precondition
(
    scalarField& x,
    const scalarField& b
) const
...
template<>
void Foam::BlockParCholeskyPrecon<scalar>::preconditionT
(
    scalarField& xT,
