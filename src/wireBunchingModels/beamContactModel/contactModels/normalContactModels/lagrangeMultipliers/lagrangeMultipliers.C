...
defineTypeNameAndDebug(lagrangeMultipliers, 0);
addToRunTimeSelectionTable(normalContactModel, lagrangeMultipliers, dictionary);
...
scalar lagrangeMultipliers::contactForce
(
    const scalar gap,
...
scalar lagrangeMultipliers::contactForceDerivative
(
    const scalar gap,
    const scalar forceOffset,
    const scalar gapOffset
