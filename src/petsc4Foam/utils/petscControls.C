...
Foam::petscControls::petscControls(const fvMesh& mesh)
:
    MeshObject<fvMesh, petscControls>(mesh)
...
const Foam::petscControls& Foam::petscControls::New(const fvMesh& mesh)
{
    return MeshObject<fvMesh, petscControls>::New(mesh);
